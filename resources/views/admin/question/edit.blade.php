...
<div class="content">
    <form method="POST" action="{{ route('admin.question.update', Crypt::encrypt($data->id)) }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('put') }}
        <div class="col-lg-8 order-lg-1">
            <div class="card shadow mb-4">
                <div class="card-header">
                    <h4 class="m-0 font-weight-bold text-white">Edit Pertanyaan</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="pl-lg-4">
                        <div class="form-group{{ $errors->has('question') ? ' has-error' : '' }}">
                            ...
                            <textarea class="ckeditor form-control" id="question" name="question" required>{{$data->question}}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('option1') ? ' has-error' : '' }}">
                            ...
                            <input id="option1" type="text" class="form-control" name="option1" value="{{ $data->option1 }}" required>
                        ...
                        <div class="form-group{{ $errors->has('option2') ? ' has-error' : '' }}">
                            ...
                            <input id="option2" type="text" class="form-control" name="option2" value="{{ $data->option2 }}" required>
                        ...
                        <div class="form-group{{ $errors->has('option3') ? ' has-error' : '' }}">
                            ...
                            <input id="option3" type="text" class="form-control" name="option3" value="{{ $data->option3 }}" required>
                        ...
                        <div class="form-group{{ $errors->has('option4') ? ' has-error' : '' }}">
                            ...
                            <input id="option4" type="text" class="form-control" name="option4" value="{{ $data->option4 }}" required>
                        ...
                        <div class="form-group{{ $errors->has('option5') ? ' has-error' : '' }}">
                            ...
                            <input id="option5" type="text" class="form-control" name="option5" value="{{ $data->option5 }}" required>
                        ...
                        <div class="form-group{{ $errors->has('answer') ? ' has-error' : '' }}">
                            ...
                            <input id="answer" type="text" class="form-control" name="answer" value="{{ $data->answer }}" required>
